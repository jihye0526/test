...
<head>
<meta charset="UTF-8">
<title>자기PR 사이트 회원가입</title>
<link rel="stylesheet" href="http://localhost:9000/SistProject/css/myprsite.css">
</head>
<body>
	<section class="join_intro">	
	<div>
		<img src="http://localhost:9000/SistProject/images/saram.png" class="logo">
		<div class="c1">
			<input type="checkbox" name="join_check1" class="jchk">사람온 이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 정보 수신(선택)에 모두 동의합니다.
		</div>
		<div class="c2">
			<div><input type="checkbox" name="join_check2" class="jchk">사람온 이용약관 동의<span class="green">(필수)</span></div>
			<textarea name="join_text2">여러분을 환영합니다.
...
단체회원 계정 사용에서의 관리자, 멤버 등의 권한 및 (공동)책임에 관한 사항 등은 계정 운영정책 및 고객센터 내 사람온 단체회원(단체 아이디) 소개 등에서 확인해 주시기 바랍니다.
		...
		<div class="c3">
			<div><input type="checkbox" name="join_check3" class="jchk">개인정보 수집 및 이용 동의<span class="green">(필수)</span></div>
			<textarea name="join_text3">개인정보보호법에 따라 사람온에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
이와 같이 수집된 정보는 개인정보와의 연계 여부 등에 따라 개인정보에 해당할 수 있고, 개인정보에 해당하지 않을 수도 있습니다.
		...
		<div class="c4">
			<div><input type="checkbox" name="join_check4" class="jchk">위치정보 이용약관 동의<span class="gray">(선택)</span></div>
			<textarea name="join_text4">위치정보 이용약관에 동의하시면, 위치를 활용한 광고 정보 수신 등을 포함하는 사람온 위치기반 서비스를 이용할 수 있습니다.
...
②제1항 위치기반서비스의 이용요금은 무료입니다.
		...
		<div class="c4">
			<input type="checkbox" name="join_check4" class="jchk">프로모션 정보 수신 동의<span class="green">(선택)</span>
			<p>사람온에서 제공하는 이벤트/혜택 등 다양한 정보를 휴대전화(사람온앱 알림 또는 문자), 이메일로 받아보실 수 있습니다. 일부 서비스(별도 회원 체계로 운영하거나 사람온 가입 이후 추가 가입하여 이용하는 서비스 등)의 경우, 개별 서비스에 대해 별도 수신 동의를 받을 수 있으며, 이때에도 수신 동의에 대해 별도로 안내하고 동의를 받습니다.</p>
		</div>
		<div class="c5">
			<button type="button" class="cancel">취소</button>
			<a href="http://localhost:9000/SistProject/join/join.jsp"><button type="button" class="confirm">확인</button></a>
		</div>
	</div>
	</section>
</body>
